...
<aside id="mobile-menu" class="md:hidden fixed top-0 right-0 h-screen w-[280px] bg-white z-[1002] shadow-lg closed flex flex-col">
    ...
    <div class="flex-grow overflow-y-auto p-4 flex flex-col gap-2 text-[#004d2d]">
        ...
        <a onclick="toggleMobileMenu()" href="index.php?page=assets" class="flex items-center gap-4 p-4 rounded-xl hover:bg-green-50 transition <?= active(['assets','asset_detail','add_asset','edit_asset','asset_report2']) ?>">
            <i class="fas fa-boxes-stacked w-6 text-lg text-center"></i>
 ...
 <div class="p-[25px_15px] text-center flex flex-col justify-center items-center relative">
    ...
    <nav class="flex-grow p-[10px] flex flex-col gap-1 overflow-x-hidden">
        <a href="index.php?page=dashboard"
           class="flex items-center p-[12px_15px] rounded-lg transition hover:bg-[rgba(0,128,0,0.05)] <?= active('dashboard') ?>">
        ...
        <a href="index.php?page=assets"
           class="flex items-center p-[12px_15px] rounded-lg transition hover:bg-[rgba(0,128,0,0.05)] <?= active(['assets','asset_detail','add_asset','edit_asset','asset_report2']) ?>">
            <i class="fas fa-boxes-stacked w-[25px] text-lg text-center"></i>
            <span class="sidebar-text ml-3 font-medium">Assets</span>
        </a>

        <a href="index.php?page=employee"
           class="flex items-center p-[12px_15px] rounded-lg transition hover:bg-[rgba(0,128,0,0.05)] <?= active(['person_detail','employee']) ?>">
        ...
        <a href="index.php?page=maintenance"
           class="flex items-center p-[12px_15px] rounded-lg transition hover:bg-[rgba(0,128,0,0.05)] <?= active('maintenance') ?>">
            <i class="fas fa-circle-exclamation w-[25px] text-lg text-center"></i>
        ...
        <?php if (isset($_SESSION['role']) && $_SESSION['role'] === 'Manager'): ?>
            ...
            <a href="index.php?page=users"
               class="flex items-center p-[12px_15px] rounded-lg transition hover:bg-[rgba(0,128,0,0.05)] <?= active('users') ?>">
            ...
            <a href="index.php?page=logs"
               class="flex items-center p-[12px_15px] rounded-lg transition hover:bg-[rgba(0,128,0,0.05)] <?= active('logs') ?>">
